...
v-form(ref="form" :model="content_type")
  v-text-field(label="Name" v-model="content_type.name" @input="updateSlug" hint="The name of your content type (e.g. Post)")

  v-text-field(label="Slug" :prefix="workspaceUrl" v-model="content_type.slug" hint="The URL path of your content type (e.g. posts)")
